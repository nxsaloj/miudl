    ...
    liveSearchListener: function () {
      ...
      this.$searchbox.on('input propertychange', function () {
        ...
        if (searchValue) {
          ...
          if (!searchMatch.length && !that.options.vueSearch) {
            no_results.className = 'no-results';
            //no_results.innerHTML = (that.options.vueSearch)? that.options.vueSearchText.replace('{0}', '"' + htmlEscape(searchValue) + '"'):that.options.noneResultsText.replace('{0}', '"' + htmlEscape(searchValue) + '"');

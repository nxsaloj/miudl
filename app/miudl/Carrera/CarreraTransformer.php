...
use miudl\Facultad\Facultad;

class CarreraTransformer extends \App\Utils\BaseSerializer
{
    ...
    public function transform($data)
    {
        $values = array(
            ...
            'Nombre'      => $data->Nombre,
            'Ciclos'      => $data->Ciclos,
            'Facultad'      => ($data->Facultad_id)? new Facultad(array("id"=>$data->Facultad_id,"Nombre"=>$data->Facultad_Nombre)):null,

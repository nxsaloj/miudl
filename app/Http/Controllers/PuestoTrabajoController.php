...
class PuestoTrabajoController extends Controller
{
    ...
    public function getPuestosTrabajoAPI(Request $request)
    {
        ...
        //$serialized = Serializer::serializeArray($data, new PuestoTrabajoTransformer(null,['Deleted_at','created_at','updated_at']));
        //$serialized = Serializer::serializeArray($data, new PuestoTrabajoTransformer);
